...
export const ModalDeleteMessage = ({ open, setOpen, cancelButtonRef, confirmAction, title, labelButonConfirm, loadingDeleteMessage }) => {
    return (
        <Modal
            open={open}
            setOpen={setOpen}
                    ...
                    <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                        ...
                        <div className="mt-2">
                            <p className="text-sm text-gray-700">
                                {`Si borrar el mensaje ya no podras recuperarlo y no se mostrara mas en el chat.`}
                            </p>
                        </div>
                    </div>
                </div>
